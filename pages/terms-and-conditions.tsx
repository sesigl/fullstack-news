        ...
        <section className="max-w-screen-xl py-12 mx-auto md:py-16 lg:py-20 lg:px-8">
          <div className="w-full lg:space-x-8 lg:flex">
            ...
            <div className="lg:w-2/3">
              ...
              <div
                  className="px-5 sm:px-6 md:px-8 lg:px-0 mx-auto lg:mx-0 prose sm:prose-lg hover:prose-a:text-red-700 prose-a:duration-300 prose-a:ease-in-out prose-a:transition prose-img:rounded-xl first-letter:text-4xl first-letter:font-bold first-letter:tracking-[.15em]"></div>
              {
                //@ts-ignore
                <div name="termly-embed" data-id="56f5d71c-a81b-4e70-b3f4-3a8f663b9f04"
