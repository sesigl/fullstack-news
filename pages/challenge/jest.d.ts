...
declare namespace jest {
  ...
  function spyOn<T extends {}, M extends ConstructorPropertyNames<Required<T>>>(
      ...
      ? SpyInstance<InstanceType<ConstructorProperties<Required<T>>[M]>,
  ...
  type ExtendedMatchers<TMatchers extends ExpectExtendMap, TMatcherReturn, TActual> =
      Matchers<TMatcherReturn,
          TActual>
      & { [K in keyof TMatchers]: CustomJestMatcher<TMatchers[K], TMatcherReturn> };
  type JestExtendedMatchers<TMatchers extends ExpectExtendMap, TActual> = JestMatchersShape<ExtendedMatchers<TMatchers, void, TActual>,
   ...
   */
  type SpiedClass<T extends abstract new (...args: any) => any> = SpyInstance<InstanceType<T>,
  ...
  type MockedFunction<T extends (...args: any[]) => any> =
      MockInstance<ReturnType<T>, ArgsType<T>>
      & T;
  ...
  type MockedClass<T extends Constructable> = MockInstance<InstanceType<T>,
